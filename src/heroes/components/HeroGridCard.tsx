      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1">
            ...
            <Progress value={65} className="h-2" activeColor='bg-orange-500' />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress value={50} className="h-2" activeColor='bg-blue-500' />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress value={80} className="h-2" activeColor='bg-green-500' />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
